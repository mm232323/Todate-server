...
var datebase_uri_1 = require("../lib/datebase_uri");
exports.client = new mongodb_1.MongoClient(datebase_uri_1.uri);
var connectToDB = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_1 = _a.sent();
                console.log("Error occured when connecting to DB: " + err_1);
                return [3 /*break*/, 3];
